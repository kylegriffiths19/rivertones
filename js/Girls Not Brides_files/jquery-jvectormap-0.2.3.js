...
(function( $ ){
  ...
  var WorldMap = function(params) {
    ...
    $('<div/>').addClass('jvectormap-zoomin').html('<span class="ss-icon ss-standard">&#x002B;</span>').appendTo(params.container);
    $('<div/>').addClass('jvectormap-zoomout').html('<span class="ss-icon ss-standard">&#x002D;</span>').appendTo(params.container);
